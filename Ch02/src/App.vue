...
export default {
  ...
  data() {
    return {
      ...
      isActive: false,
      name: "홍길동", // 이름 input에 작성하면 이름 : 에 출력
      message: "", // 내용 작성하면 글자수 카운트
      isChecked: false, // 체크하면 true 해제하면 false
      hobbies: [], // 체크한 내용 선택값에 배열
      country: "한국", // 기본 표시 : 한국
      user: {
        uid: "",
        name: "",
  ...
  methods: {
    ...
    // 이벤트 안에 타겟을 설정해서 선택할때마다 alert 띄움
